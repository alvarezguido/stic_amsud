...
seed = 1
file_name="lorawan_pAloha_noACK_1CH_s1/lorawan_pAloha_noACK_1CH__s{}.csv".format(seed)
...
plt.savefig("plots/metrics-DER-s{}.png".format(seed), format='png', dpi=300)
plt.savefig("plots/metrics-DER-s{}.pdf".format(seed), format='pdf')
...
plt.savefig("plots/metrics-S-s{}.png".format(seed), format='png', dpi=300)
plt.savefig("plots/metrics-S-s{}.pdf".format(seed), format='pdf')
