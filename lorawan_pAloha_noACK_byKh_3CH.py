...
mode_debbug = 0 ##testing under IPython
...
save_data = 1 #to save data to file
show_prints = 0
show_results = 1
...
# =============================================================================
    ...
    S_analytic2 = G*np.exp(-2*(1/3)*G) #considering re-transmisions
...
if save_data:
    ...
    RANDOM_SEED = seed
    folder = name+'_3CH_s'+str(RANDOM_SEED)
    if not os.path.exists(folder):
        os.makedirs(folder)
    fname = "./"+folder+"/" + str(name+"_3CH_"+"_s"+str(RANDOM_SEED))+".csv"
